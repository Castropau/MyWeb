...
<body>
 ...
 <div class="container">
    ...
    <li><a href="communities.php">COMMUNITY</a></li>
            ...
            <i class="fa-solid fa-user"></i><?php echo $name;?></i>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE users SET firstname='$firstname', lastname='$lastname', ign='$ign', bio='$bio', about='$about' WHERE id='$id'";
    ...
    if ($row = mysqli_fetch_assoc($result)) {
        ...
        $id = $row['users_id'];
        $image = $row['image'];
        // add the following line to get the image from the database
        $image = 'uploads/' . $image; // replace with the actual path or URL of the image
...
<div class="profile-container">
    <div class="profile-header">
        <img class="profile-picture" src="<?php echo $image; ?>" />
    ...
    <?php if ($verify == "verified") { ?>
      <a href="verify.php">
        <button class="chat-button">Verified</button>
        </a>
    <?php } else { ?>
        <a href="verify.php">
            <button class="chat-button">Verify</button>
        </a>
    <?php } ?>
</div>
    ...
    <div class="profile-body">
        <div class="profile-section">
            ...
            <?php if (isset($bio) && strlen($bio) > 40) { ?>
                <p><?php echo preg_replace('/\s+/', ' ', wordwrap($bio, 40, " \n", true)); ?></p>
            <?php } else if (isset($bio)) { ?>
                <p><?php echo $bio; ?></p>
            <?php } ?>
        </div>
        </br>
        <div class="profile-section">
            ...
            <ul class="section-content">
                <?php if (isset($about) && strlen($about) > 40) { ?>
                    <p><?php echo preg_replace('/\s+/', ' ', wordwrap($about, 40, " \n", true)); ?></p>
