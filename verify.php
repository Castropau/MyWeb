...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['profile-picture']) && $_FILES['profile-picture']['error'] == 0) {
        ...
        if (in_array($file_ext, $allowed_types)) {
            ...
            $sql = "UPDATE users SET firstname='$firstname', middlename='$middlename', lastname='$lastname', images='$new_file_name', verify='unverified' WHERE id='$id'";
            if (mysqli_query($conn, $sql)) {
                $success_message = "Your verification request is submitted!.";
        ...
        $sql = "UPDATE users SET firstname='$firstname',middlename='$middlename', lastname='$lastname' WHERE id='$id'";
        if (mysqli_query($conn, $sql)) {
            $success_message = "Your verification request is submitted!.";
        } else {
            $error_message = "An error occurred while updating your information.";
...
<form class="form" id="form" action="" enctype="multipart/form-data" method="post">
  ...
  <div style="background-color: #f7f7f7; padding: 20px; text-align: center;">
    <h2 style="color: #ff9900; font-size: 24px; margin-bottom: 10px;">Congratulations, <?php echo $firstname; ?> <?php echo $lastname; ?>!</h2>
    <p style="color: #555555; font-size: 18px;">Your account is verified<iconify-icon style="color: #33ccff;" icon="heroicons-solid:badge-check"></iconify-icon></p>
    <img class="profile-picture" id="preview-image" src="<?php echo $image; ?>" style="width: 150px; margin-top: 20px;">
  </div>
<?php else: ?>
  <form method="post">
    ...
    <h2 class="section-title" style="text-align: center; margin-right: 250px">ID</h2>

    <div class="profile-picture-container">
      <img class="profile-picture" id="preview-image" src="image.jpg" />
    ...
    <div class="profile-section">
      <?php if (!empty($message)): ?>
        ...
        <textarea name="about" readonly><?php echo $message; ?></textarea>
      <?php endif; ?>
    </div>
